...
public class ServiceController {
    ...
    public ExecuteResult<List<HeatMapAO>>  getServiceHeatMap(@RequestParam("TargetId") String targetId,@RequestParam(value="Startdate",required=false) String startDate,@RequestParam(value="EndDate",required=false) String endDate){
     ...
     */
    @GetMapping("/image")
    public ExecuteResult<QueryImageAO> getImageById(@RequestParam("ServiceId") String serviceId,@RequestParam("ImageId") String imageId){
