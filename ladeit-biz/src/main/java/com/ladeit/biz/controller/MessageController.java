...
public class MessageController {
    ...
    */
    ...
    public ExecuteResult<Pager<SqlRow>> getUserMessageInfos(@RequestParam("currentPage") int currentPage,
                                                        @RequestParam("pageSize") int pageSize,@RequestParam(value="readFlag",required=false) String readFlag,@RequestParam(value="serviceGroupId",required=false) String serviceGroupId,@RequestParam(value="type",required=false) String type){
