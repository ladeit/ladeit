...
public class EnvDaoImpl implements EnvDao {
    ...
    public Env getEnvByClusterAndNamespace(String clusterId, String namespace) {
        return this.server.createQuery(Env.class).where().eq("clusterId", clusterId).eq("namespace", namespace).eq("isdel", false).findOne();
    }
    ...
    public Env getEnvByClusterAndEnvId(String clusterId, String envId) {
        return this.server.createQuery(Env.class).where().eq("clusterId", clusterId).eq("id", envId).eq("isdel", false).findOne();
    }
}
